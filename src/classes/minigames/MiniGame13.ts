...
export default class MiniGame13 extends MGMain{
   ...
   */
    constructor(ctx:CanvasRenderingContext2D,room:Room, canvas: HTMLCanvasElement){
      super(13,room,ctx, canvas,["0","9","2","3","d","a","v","i","d"],[null,null,null,null,null,null,null,null,null])
   ...
   */
    ...
    this.writeTextToCanvas("voornaam: David", 20, 850, 160)
    this.writeTextToCanvas("achternaam: Hill", 20, 850, 190)
    this.writeTextToCanvas("geboorte datum: 09/23/1975", 20, 850, 220)
    this.writeTextToCanvas("woonplaats: Rome", 20, 850, 250)
