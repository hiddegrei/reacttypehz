...
export default class MiniGame4 extends MGMain{
   ...
   */
    constructor(ctx:CanvasRenderingContext2D,room:Room, canvas: HTMLCanvasElement){
      ...
      this.secretW=["s","l","o","g","a","n","8","8","9"]
   ...
   */
    ...
    this.writeTextToCanvas("voornaam: Peter", 20, 850, 160)
    this.writeTextToCanvas("achternaam: Sagan", 20, 850, 190)
    this.writeTextToCanvas("geboorte datum: 08/09/1988", 20, 850, 220)
    this.writeTextToCanvas("woonplaats: Slovakije", 20, 850, 250)
